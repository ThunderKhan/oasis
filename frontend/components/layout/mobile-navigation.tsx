  ...
  const drawer = open ? (
    <div className="fixed inset-0 z-50 md:hidden">
      <button
        ...
        className="absolute inset-0 cursor-default bg-foreground/25 backdrop-blur-[2px] motion-safe:transition-opacity motion-safe:duration-200"
      ...
      <div
        ...
        className="absolute inset-y-0 right-0 flex w-[min(88vw,24rem)] flex-col border-l border-border bg-surface shadow-2xl motion-safe:animate-[slide-in_240ms_cubic-bezier(0.22,1,0.36,1)]"
      >
        ...
        <div className="border-t border-border p-4">
          ...
          <p className="mt-3 text-center text-xs leading-relaxed text-subtle">Clinical decision support, not a diagnostic tool.</p>
        </div>
      </div>
    </div>
  ) : null
