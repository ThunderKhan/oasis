...
import { SCORE_CAVEAT } from "@/lib/priority-config"
...
const SEGMENTS = ["Lower", "Monitor", "Screen", "Assess", "Follow up", "Refer"]

function fillClass(priority: Priority) {
  if (priority === "prompt_referral") return "bg-urgency-referral"
  if (priority === "clinical_follow_up") return "bg-urgency-followup"
  if (priority === "specialist_risk_assessment") return "bg-urgency-specialist"
  if (priority === "priority_screening") return "bg-urgency-priority"
  if (priority === "screening_due") return "bg-urgency-screening"
